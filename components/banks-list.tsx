...
// Saralash uchun ustunlar
type SortKey = "company_name" | "followers" | "following"
          ...
          <thead>
            <tr className="border-b border-slate-800">
              ...
              <th
                ...
                className="text-right py-3 px-4 text-slate-400 font-semibold cursor-pointer hover:text-white"
              >
                Obunalar soni {sortKey === "following" && (sortOrder === "asc" ? "▲" : "▼")}
              </th>
            ...
            {sortedData.map((bank) => (
              ...
              >
                ...
                <td className="py-3 px-4 text-right text-white">
                  {bank.followers?.toLocaleString()}
                </td>

                <td className="py-3 px-4 text-right text-slate-300">
                  {bank.following?.toLocaleString()}
                </td>
